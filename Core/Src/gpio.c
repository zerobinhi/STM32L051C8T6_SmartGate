...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, IO1_Pin|IO3_Pin|IO2_Pin|IO4_Pin
                          |IO6_Pin|IO5_Pin|IO7_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : IO3_Pin IO2_Pin IO4_Pin IO6_Pin
                           IO5_Pin IO7_Pin */
  GPIO_InitStruct.Pin = IO3_Pin|IO2_Pin|IO4_Pin|IO6_Pin
                          |IO5_Pin|IO7_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
